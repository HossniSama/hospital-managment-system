...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
  <div class="w3-display-middle" style="white-space:nowrap;">
     <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-black w3-opacity-min"><b>H O S P I T A L</b></span> <span class="w3-hide-small w3-text-light-grey">MANAGEMENT SYSTEM</span></h1>
     <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a>EFFICIENT DOCTOR PATIENT</a></h6>
...
<div class="w3-content w3-container w3-padding-64" id="about">
  ...
  <p>Efficient doctor patient portal is a managing system that helps doctors as well as the patients by providing options of booking appointments as per the convenience of both doctor and patients with the motive of medical progress.
      ...
      Doctors maintain the medical history of the patient into their database so that every time any particular patient logs into the system, he/she can easily access their complete medical history whenever needed.
      ...
      The system also contains an organ donor module.
      This module has an option for the registration of organ donation along with an organ search option.
